<template>
<div>
  <pa-content-sample-header title="上传身份证 TakePhotos"></pa-content-sample-header>

  <pa-content-sample title="基础用法" tips="基础的按钮用法">
    <div slot="source">
      <take-photos link-previous="/read-card-id" :next-call="next"
          :business-jnl-no="BusinessJnlNo" :pro-id="proId"></take-photos>
    </div>
