...
Component.options.__file = "D:\\BM_Work\\web_app_work\\FbVueDemo\\pingAnFaceBank_1.5.5\\pa-ui-src\\components\\input\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3c40e755", Component.options)
  } else {
    hotAPI.reload("data-v-3c40e755", Component.options)
  }
})()}
...
exports.default = {
	...
	watch: {
		valueModel: function valueModel(newValue, oldValue) {
			if (this.inputDataPattern) {
				// 有输入校验时
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.isShowClearIcon),
      expression: "isShowClearIcon"
    }],
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.isShowErrorTip),
      expression: "isShowErrorTip"
    }],
    staticClass: "input-error-tip"
  }, [_c('i', {
    staticClass: "icon-fail-verify input-error-icon"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3c40e755", module.exports)
  }
}
