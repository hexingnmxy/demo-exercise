<template>
<div>
  <pa-content-sample-header title="刷卡页面 SwipeCard"></pa-content-sample-header>

  <pa-content-sample title="基础用法" tips="基础的按钮用法">
    <div slot="source" class="swipe-card-source-content">
      <swipe-card v-model="buttonState" swipe-type="bankCard" :swipe-success="finish" :pop-password="false"></swipe-card>
    </div>
