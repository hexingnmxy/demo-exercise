window.mobileUtil = function (e, i) {
  ...
  return {
    ...
    fixScreen: function () {
      var t = i.querySelector('meta[name="viewport"]'),
        n = t ? t.content : "",
        s = n.match(/initial\-scale=([\d\.]+)/),
        a = n.match(/width=([^,\s]+)/);
      if (r && !s && (a && a[1] != "device-width")) {
        var o = function () {
          var i = parseInt(a[1]),
            s = e.innerWidth || i,
            r = e.outerWidth || s,
            o = e.screen.width || s,
            c = e.screen.availWidth || s,
            l = e.innerHeight || i,
            g = e.outerHeight || l,
            u = e.screen.height || l,
            h = e.screen.availHeight || l,
            m = Math.min(s, r, o, c, l, g, u, h),
            p = m / i;
          if (p < 1) {
            t.content = n + "," + d(p)
          }
    ...
    getSearch: function (i) {
      i = i || e.location.search;
      var t = {},
        n = new RegExp("([^?=&]+)(=([^&]*))?", "g");
      i && i.replace(n, function (e, i, n, s) {
        t[i] = s
      });
      return t
    }
